...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/bitingbugs_libraries_yml_2}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/bitingbugs_libraries_yml}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/bitingbugs_libraries_yml_print}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/bitingbugs_info_file_libraries}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/bitingbugs_libraries_yml_attach}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/bitingbugs_dot_theme_file}
...
You can also attach a library in a twig template by using the attach\_library() twig function So in any \url{*.html.twig}:



\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/bitingbugs_attach_lib_in_twig_file}
...
\begin{enumerate}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{chapter10/bitingbugs_recipes_pages_structure}
	...
	\begin{figure}[H]
		\centering
		\includegraphics[width=\textwidth]{chapter10/bitingbugs_recipes_page_themed}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/closures_js}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/passing_jquery}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/document_ready}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/new_class}
	\label{fig:new_class}
\end{figure}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/closure_map_jquery}
...
\begin{figure}[H]
	\centering
	\includegraphics[width=\textwidth]{chapter10/drupal_ininitescroll}
